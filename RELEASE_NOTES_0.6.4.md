...
- A futó alkalmazás pontos verziója most mindig jól látható a jobb alsó sarokban.
- A sarokjelvény a ténylegesen futó verziót mutatja automatikusan.
- Az értesítések a verziójelvény fölött jelennek meg, így nem takarják el egymást.
...
- The exact running app version is now always visible in the bottom-right corner.
- The corner badge automatically shows the version that is actually running.
- Notifications appear above the version badge, so they never cover each other.
